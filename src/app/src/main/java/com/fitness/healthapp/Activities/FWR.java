 ...
 */
public class FWR extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    /**
     * Whether or not the system UI should be auto-hidden after
     * {@link #AUTO_HIDE_DELAY_MILLIS} milliseconds.
     */

    private static final String TAG = FWR.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_fwr );
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        DrawerLayout drawer = (DrawerLayout) safeFindViewById(R.id.my_drawer_layout);
